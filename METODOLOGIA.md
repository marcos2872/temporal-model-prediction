# Metodologia — modelos de predição temporal

Base teórica do projeto: o que é predição temporal, a taxonomia das famílias de
modelos, a matemática de cada uma, o roteiro prático de criação e a busca
bibliográfica sistemática que ancora tudo (ver §7).
...
## 7. Busca bibliográfica sistemática — modelos de predição temporal (2026-09-10)
