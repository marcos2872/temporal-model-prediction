...
Artefatos gerados por `univariavel/notebooks/06-ensemble-ph.ipynb` (executado de ponta a ponta, 0 erros;
procedência: `temporal-remote` 192.168.1.6, dir `/home/marcos/temporal-model`, 12c).
Reproduzir: `.venv/bin/jupyter nbconvert --to notebook --execute --inplace --ExecutePreprocessor.timeout=2400 univariavel/notebooks/06-ensemble-ph.ipynb`
...
| `modelos/lgbm_steps.pkl.gz` | 288 regressores (43 MB; no Release `modelos-v1`, regenerável; o `.pkl` de 124 MB é gitignored) |
