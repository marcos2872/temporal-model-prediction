...
Artefatos gerados por `univariavel/notebooks/12-v2-lstnet-ph.ipynb` (rerun pós-fix do groupby,
...
Reproduzir: `.venv/bin/jupyter nbconvert --to notebook --execute --inplace --ExecutePreprocessor.timeout=2400 univariavel/notebooks/12-v2-lstnet-ph.ipynb`
