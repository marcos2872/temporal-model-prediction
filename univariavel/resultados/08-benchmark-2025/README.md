...
Artefatos gerados por `univariavel/notebooks/08-benchmark-2025.ipynb` (executado de ponta a ponta, 0 erros;
procedência: `temporal-remote` 192.168.1.6, dir `/home/marcos/temporal-model`, 12c livres).
Reproduzir: `.venv/bin/jupyter nbconvert --to notebook --execute --inplace --ExecutePreprocessor.timeout=2400 univariavel/notebooks/08-benchmark-2025.ipynb`
...
### Erro por horizonte + MASE (`univariavel/notebooks/09-analises-pos-benchmark.ipynb`, Fase 1.1)
...
### Diebold-Mariano ens × lstnet (`univariavel/notebooks/09-analises-pos-benchmark.ipynb`, Fase 1.2; séries em `metricas_dm_{ph,od}.csv`)
...
### Climatologia — baseline de custo zero, DESCARTADO (`univariavel/notebooks/09-analises-pos-benchmark.ipynb`, Fase 1.3)
