...
| [`00b-baseline-od/`](00b-baseline-od/) | Mesmo protocolo no OD 2024 | sazonal 0,1579; MM 0,3260; ARIMA 0,3893; Prophet 0,4091 (colapsa) |
...
| [`02b-lstnet-od/`](02b-lstnet-od/) | Mesmo método no OD — **NOVA RÉGUA OD (1ª vez)** | **lstnet 0,1380**, −12,6% sobre o sazonal 0,1579 |
| [`03-patchtst-ph/`](03-patchtst-ph/) | PatchTST + DLinear no pH, régua 02 recarregada — régua segue LSTNet | lstnet 0,0373; dlinear 0,0394; patchtst 0,0414 (overfita); sazonal 0,0421 |
| [`03b-patchtst-od/`](03b-patchtst-od/) | Os três no OD — régua segue LSTNet | lstnet 0,1380; patchtst 0,1432; dlinear 0,1435; sazonal 0,1579 |
| [`04-ensemble-ph/`](04-ensemble-ph/) | Ensemble (piso + 288 LGBM + DLinear-res + NNLS) no pH — **NOVA RÉGUA pH** | **ens 0,0357** (−4,3% sobre lstnet); NNLS zera o LGBM |
| [`04b-ensemble-od/`](04b-ensemble-od/) | Mesmo método no OD — **NOVA RÉGUA OD** | **ens 0,1325** (−4,0% sobre lstnet); dlres com peso 0,30 |
...
experimentos 00–08 antigos, notebooks 01/05/06/07). Todo esse material foi removido em
13/09/2026 na migração para o regime anual — permanece recuperável no histórico do git.
