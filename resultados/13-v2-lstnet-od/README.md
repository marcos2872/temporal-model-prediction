...
Artefatos gerados por `notebooks/13-v2-lstnet-od.ipynb` (executado de ponta a ponta,
...
Reproduzir: `.venv/bin/jupyter nbconvert --to notebook --execute --inplace --ExecutePreprocessor.timeout=2400 notebooks/13-v2-lstnet-od.ipynb`
...
- **Série:** OD 2024 (`dados/treino/ef01-mogi-das-cruzes_oxigenio-dissolvido_2024.csv`), 105.121 slots, 0,6% faltantes (594)
