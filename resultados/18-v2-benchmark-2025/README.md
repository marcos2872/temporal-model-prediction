...
Artefatos gerados por `notebooks/18-v2-benchmark-2025.ipynb` (executado de ponta a ponta, 0 erros;
...
Reproduzir: `.venv/bin/jupyter nbconvert --to notebook --execute --inplace --ExecutePreprocessor.timeout=7200 notebooks/18-v2-benchmark-2025.ipynb`
